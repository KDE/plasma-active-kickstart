...
repo --name=mer-plasma-shared --baseurl=http://repo.pub.meego.com/CE:/MW:/PlasmaActive/CE_MW_Shared_i586/ --save
...
echo "2012-04-20-15-07-basyskom-plasma-active-devel-mer-usb-live" >> /etc/image-release
